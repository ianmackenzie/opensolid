...
foreign import capi unsafe "bytecode.h opensolid_curve_value"
  opensolid_curve_value ::
    CString -> Double -> Ptr Double -> IO ()

foreign import capi unsafe "bytecode.h opensolid_curve_bounds"
  opensolid_curve_bounds ::
    CString -> Double -> Double -> Ptr Double -> IO ()

foreign import capi unsafe "bytecode.h opensolid_surface_value"
  opensolid_surface_value ::
    CString -> Double -> Double -> Ptr Double -> IO ()

foreign import capi unsafe "bytecode.h opensolid_surface_bounds"
  opensolid_surface_bounds ::
    CString -> Double -> Double -> Double -> Double -> Ptr Double -> IO ()

foreign import capi unsafe "bytecode.h opensolid_solve_monotonic_surface_u"
  opensolid_solve_monotonic_surface_u ::
    Double -> CString -> CString -> Double -> Double -> Double -> Double

foreign import capi unsafe "bytecode.h opensolid_solve_monotonic_surface_v"
  opensolid_solve_monotonic_surface_v ::
    Double -> CString -> CString -> Double -> Double -> Double -> Double
