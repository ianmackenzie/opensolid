...
metal baseColor ("roughness" ::: roughness) = PbrMaterial{baseColor, metallic = 1.0, roughness}
...
nonmetal baseColor ("roughness" ::: roughness) = PbrMaterial{baseColor, roughness, metallic = 0.0}
...
custom baseColor ("metallic" ::: metallic) ("roughness" ::: roughness) =
  PbrMaterial{baseColor, metallic, roughness}
