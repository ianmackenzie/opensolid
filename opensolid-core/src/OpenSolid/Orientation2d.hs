...
placeIn :: Frame2d global frameUnits local -> Orientation2d local -> Orientation2d global
...
relativeTo :: Frame2d global frameUnits local -> Orientation2d global -> Orientation2d local
