...
-}
forward :: Frame3d space defines1 -> Frame3d space defines2
...
-}
backward :: Frame3d space defines1 -> Frame3d space defines2
...
(all relative to the parent frame).
-}
leftward :: Frame3d space defines1 -> Frame3d space defines2
...
(all relative to the parent frame).
-}
rightward :: Frame3d space defines1 -> Frame3d space defines2
...
(all relative to the parent frame).
-}
upward :: Frame3d space defines1 -> Frame3d space defines2
...
(all relative to the parent frame).
-}
downward :: Frame3d space defines1 -> Frame3d space defines2
...
offsetForwardBy :: Length -> Frame3d space defines1 -> Frame3d space defines2
...
offsetBackwardBy :: Length -> Frame3d space defines1 -> Frame3d space defines2
...
offsetRightwardBy :: Length -> Frame3d space defines1 -> Frame3d space defines2
...
offsetLeftwardBy :: Length -> Frame3d space defines1 -> Frame3d space defines2
...
offsetUpwardBy :: Length -> Frame3d space defines1 -> Frame3d space defines2
...
offsetDownwardBy :: Length -> Frame3d space defines1 -> Frame3d space defines2
...
-}
turnLeftBy :: Angle -> Frame3d space defines1 -> Frame3d space defines2
...
-}
turnRightBy :: Angle -> Frame3d space defines1 -> Frame3d space defines2
...
-}
rollRightBy :: Angle -> Frame3d space defines1 -> Frame3d space defines2
...
-}
rollLeftBy :: Angle -> Frame3d space defines1 -> Frame3d space defines2
...
-}
tiltUpBy :: Angle -> Frame3d space defines1 -> Frame3d space defines2
...
-}
tiltDownBy :: Angle -> Frame3d space defines1 -> Frame3d space defines2
...
-}
turnLeft :: Frame3d space defines1 -> Frame3d space defines2
...
-}
turnRight :: Frame3d space defines1 -> Frame3d space defines2
...
will be equal to the leftward direction of the original frame.
-}
rollLeft :: Frame3d space defines1 -> Frame3d space defines2
...
will be equal to the rightward direction of the original frame.
-}
rollRight :: Frame3d space defines1 -> Frame3d space defines2
...
-}
tiltUp :: Frame3d space defines1 -> Frame3d space defines2
...
-}
tiltDown :: Frame3d space defines1 -> Frame3d space defines2
...
moveTo :: Point3d space -> Frame3d space defines1 -> Frame3d space defines2
moveTo newOriginPoint (Frame3d _ o) = Frame3d newOriginPoint (Orientation3d.coerce o)

-- | Apply the given transform to a frame.
transformBy :: Transform3d.Rigid space -> Frame3d space defines1 -> Frame3d space defines2
...
translateAlong :: Axis3d space -> Length -> Frame3d space defines1 -> Frame3d space defines2
translateAlong = Transform3d.translateAlongImpl transformBy

rotateAround :: Axis3d space -> Angle -> Frame3d space defines1 -> Frame3d space defines2
