...
extend curve saddleRegion = do
  ...
  let startExtension =
        SaddleRegion.connectingCurves (SaddleRegion.Outgoing segments.first) saddleRegion
  let endExtension =
        SaddleRegion.connectingCurves (SaddleRegion.Incoming segments.last) saddleRegion
