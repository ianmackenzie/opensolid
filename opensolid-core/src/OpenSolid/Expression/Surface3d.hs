...
relativeTo frame expression = do
  ...
  xyz
    (displacement <> Expression.VectorSurface3d.constant i)
    (displacement <> Expression.VectorSurface3d.constant j)
    (displacement <> Expression.VectorSurface3d.constant k)
