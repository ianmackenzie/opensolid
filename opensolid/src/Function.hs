...
expression1d :: Qty units -> Expression input
expression1d value = Expression.constant (Units.coerce value)

curve1d :: Qty units -> Function Float (Qty units)
curve1d x = Curve1d (expression1d x)

surface1d :: Qty units -> Function Uv.Point (Qty units)
surface1d x = Surface1d (expression1d x)

curve2d :: Point2d (space @ units) -> Function Float (Point2d (space @ units))
curve2d (Point2d x y) = Curve2d (expression1d x) (expression1d y)

surface2d :: Point2d (space @ units) -> Function Uv.Point (Point2d (space @ units))
surface2d (Point2d x y) = Surface2d (expression1d x) (expression1d y)

vectorCurve2d :: Vector2d (space @ units) -> Function Float (Vector2d (space @ units))
vectorCurve2d (Vector2d x y) = VectorCurve2d (expression1d x) (expression1d y)

vectorSurface2d :: Vector2d (space @ units) -> Function Uv.Point (Vector2d (space @ units))
vectorSurface2d (Vector2d x y) = VectorSurface2d (expression1d x) (expression1d y)

curve3d :: Point3d (space @ units) -> Function Float (Point3d (space @ units))
curve3d (Point3d x y z) = Curve3d (expression1d x) (expression1d y) (expression1d z)

surface3d :: Point3d (space @ units) -> Function Uv.Point (Point3d (space @ units))
surface3d (Point3d x y z) = Surface3d (expression1d x) (expression1d y) (expression1d z)

vectorCurve3d :: Vector3d (space @ units) -> Function Float (Vector3d (space @ units))
vectorCurve3d (Vector3d x y z) = VectorCurve3d (expression1d x) (expression1d y) (expression1d z)

vectorSurface3d :: Vector3d (space @ units) -> Function Uv.Point (Vector3d (space @ units))
...
instance Negation (Function input (Qty units)) where
  negate (Curve1d x) = Curve1d (Expression.negated x)
...
instance
  ...
  Addition
    ...
    (Function Float (Qty units1))
  where
  Curve1d lhs + Curve1d rhs = Curve1d (Expression.sum lhs rhs)
...
instance
  ...
  Subtraction
    ...
    (Function Float (Qty units1))
  where
  Curve1d lhs - Curve1d rhs = Curve1d (Expression.difference lhs rhs)
...
instance Multiplication' (Function Float (Qty units1)) (Function Float (Qty units2)) where
  ...
  Curve1d lhs .*. Curve1d rhs = Curve1d (Expression.product lhs rhs)
...
instance Division' (Function Float (Qty units1)) (Function Float (Qty units2)) where
  type
    Function Float (Qty units1) ./. Function Float (Qty units2) =
      Function Float (Qty (units1 :/: units2))
  Curve1d lhs ./. Curve1d rhs = Curve1d (Expression.quotient lhs rhs)
...
squared' (Curve1d expression) = Curve1d (Expression.squared expression)
...
sqrt' (Curve1d expression) = Curve1d (Expression.sqrt expression)
...
sin (Curve1d expression) = Curve1d (Expression.sin expression)
sin (Surface1d expression) = Surface1d (Expression.sin expression)

cos :: Function input Angle -> Function input Float
cos (Curve1d expression) = Curve1d (Expression.cos expression)
...
instance
  CurveDerivative
    ...
    (Function Float (Qty units))
  where
  curveDerivative (Curve1d expression) = Curve1d (Expression.curveDerivative expression)
...
instance ValueFunction (Function Float (Qty units)) (Float -> Qty units) where
  valueFunction (Curve1d expression) = do
    let f = curve1d_value_function (opensolid_curve1d_value_function (Expression.ptr expression))
...
instance BoundsFunction (Function Float (Qty units)) (Range Unitless -> Range units) where
  boundsFunction (Curve1d expression) = do
    let f = curve1d_bounds_function (opensolid_curve1d_bounds_function (Expression.ptr expression))
