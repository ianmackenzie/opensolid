module VectorCurve3d.Direction (unsafe) where
...
import VectorCurve3d.DegenerateEndpoint (DegenerateEndpoint)
import VectorCurve3d.DegenerateEndpoint qualified as DegenerateEndpoint
