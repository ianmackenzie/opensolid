...
quarterCircle =
  Test.check 1 "quarterCircle" <| Test.do
...
squareWithHole =
  Test.check 1 "squareWithHole" <| Test.do
    let width = Length.meters 2.0
    let p1 = Point2d.origin
    let p2 = Point2d.xy width zero
    let p3 = Point2d.xy width width
...
incompleteSquare =
  Test.check 1 "incompleteSquare" <| Test.do
    let width = Length.meters 2.0
    let p1 = Point2d.origin
    let p2 = Point2d.xy width zero
    let p3 = Point2d.xy width width
...
squareWithTangentHole =
  Test.check 1 "squareWithTangentHole" <| Test.do
    let width = Length.meters 2.0
    let p1 = Point2d.origin
    let p2 = Point2d.xy width zero
    let p3 = Point2d.xy width width
...
twoCircles =
  Test.check 1 "twoCircles" <| Test.do
