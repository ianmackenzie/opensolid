...
data QuadraticSpline2d units coordinates
  = QuadraticSpline2d
...
segmentBounds :: QuadraticSpline2d units coordinates -> Range Unitless -> BoundingBox2d units coordinates
...
derivative :: QuadraticSpline2d units coordinates -> VectorCurve2d units coordinates
...
instance IsCurve2d (QuadraticSpline2d units coordinates) units coordinates where
...
controlPoints :: QuadraticSpline2d units coordinates -> (Point2d units coordinates, Point2d units coordinates, Point2d units coordinates)
