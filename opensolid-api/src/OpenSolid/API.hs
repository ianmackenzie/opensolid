...
unitlessInterval =
  Class.new @UnitlessInterval "A range of unitless values, with a lower bound and upper bound." $
    ...
    , Class.factory1 "Plus Minus" "Value" Interval.plusMinus $(docs 'Interval.plusMinus)
    , Class.factory1 "Hull" "Values" Interval.hull $(docs 'Interval.hull)
    , Class.factory1 "Aggregate" "Interval" Interval.aggregate $(docs 'Interval.aggregate)
...
bounds2D =
  Class.new @Bounds2D "A bounding box in 2D." $
    ...
    , Class.factory1 "Hull" "Points" Bounds2D.hull $(docs 'Bounds2D.hull)
    , Class.factory1 "Aggregate" "Bounds" Bounds2D.aggregate $(docs 'Bounds2D.aggregate)
...
svg =
  Class.new @Svg $(docs ''Svg.Svg) $
    ...
    , Class.factory1 "Circle" "Circle" Svg.circle $(docs 'Svg.circle)
    , Class.factory2 "Circle With" "Attributes" "Circle" Svg.circleWith $(docs 'Svg.circleWith)
...
axis3D =
  Class.new @Axis3D $(docs ''Axis3D.Axis3D) $
    ...
    , Class.property "Origin Point" Axis3D.originPoint $(docs 'Axis3D.originPoint)
    , Class.property "Direction" Axis3D.direction $(docs 'Axis3D.direction)
...
planeOrientation3D =
  Class.new @PlaneOrientation3D $(docs ''PlaneOrientation3D.PlaneOrientation3D) $
    ...
    , Class.property "X Direction" (PlaneOrientation3D.xDirection) $(docs 'PlaneOrientation3D.xDirection)
    , Class.property "Y Direction" (PlaneOrientation3D.yDirection) $(docs 'PlaneOrientation3D.yDirection)
    , Class.property "Normal Direction" (PlaneOrientation3D.normalDirection) $(docs 'PlaneOrientation3D.normalDirection)
...
plane3D =
  Class.new @Plane3D $(docs ''Plane3D.Plane3D) $
    ...
    , Class.property "Origin Point" Plane3D.originPoint $(docs 'Plane3D.originPoint)
    , Class.property "X Direction" Plane3D.xDirection $(docs 'Plane3D.xDirection)
    , Class.property "Y Direction" Plane3D.yDirection $(docs 'Plane3D.yDirection)
    , Class.property "Normal Direction" (Plane3D.normalDirection) $(docs 'Plane3D.normalDirection)
    , Class.property "X Axis" (Plane3D.xAxis) $(docs 'Plane3D.xAxis)
    , Class.property "Y Axis" (Plane3D.yAxis) $(docs 'Plane3D.yAxis)
    , Class.property "Normal Axis" (Plane3D.normalAxis) $(docs 'Plane3D.normalAxis)
...
orientation3D =
  Class.new @Orientation3D $(docs ''Orientation3D.Orientation3D) $
    [ Class.property "Forward Direction" Orientation3D.forwardDirection $(docs 'Orientation3D.forwardDirection)
    , Class.property "Backward Direction" Orientation3D.backwardDirection $(docs 'Orientation3D.backwardDirection)
    , Class.property "Leftward Direction" Orientation3D.leftwardDirection $(docs 'Orientation3D.leftwardDirection)
    , Class.property "Rightward Direction" Orientation3D.rightwardDirection $(docs 'Orientation3D.rightwardDirection)
    , Class.property "Upward Direction" Orientation3D.upwardDirection $(docs 'Orientation3D.upwardDirection)
    , Class.property "Downward Direction" Orientation3D.downwardDirection $(docs 'Orientation3D.downwardDirection)
    , Class.property "Front Plane Orientation" Orientation3D.frontPlaneOrientation $(docs 'Orientation3D.frontPlaneOrientation)
    , Class.property "Back Plane Orientation" Orientation3D.backPlaneOrientation $(docs 'Orientation3D.backPlaneOrientation)
    , Class.property "Right Plane Orientation" Orientation3D.rightPlaneOrientation $(docs 'Orientation3D.rightPlaneOrientation)
    , Class.property "Left Plane Orientation" Orientation3D.leftPlaneOrientation $(docs 'Orientation3D.leftPlaneOrientation)
    , Class.property "Bottom Plane Orientation" Orientation3D.bottomPlaneOrientation $(docs 'Orientation3D.bottomPlaneOrientation)
    , Class.property "Top Plane Orientation" Orientation3D.topPlaneOrientation $(docs 'Orientation3D.topPlaneOrientation)
    , Class.property "Backward Orientation" Orientation3D.backwardOrientation $(docs 'Orientation3D.backwardOrientation)
    , Class.property "Rightward Orientation" Orientation3D.rightwardOrientation $(docs 'Orientation3D.rightwardOrientation)
    , Class.property "Leftward Orientation" Orientation3D.leftwardOrientation $(docs 'Orientation3D.leftwardOrientation)
    , Class.property "Upward Orientation" Orientation3D.upwardOrientation $(docs 'Orientation3D.upwardOrientation)
    , Class.property "Downward Orientation" Orientation3D.downwardOrientation $(docs 'Orientation3D.downwardOrientation)
...
frame3D =
  Class.new @Frame3D $(docs ''Frame3D.Frame3D) $
    ...
    , Class.property "Origin Point" Frame3D.originPoint $(docs 'Frame3D.originPoint)
    , Class.property "Forward Direction" Frame3D.forwardDirection $(docs 'Frame3D.forwardDirection)
    , Class.property "Backward Direction" Frame3D.backwardDirection $(docs 'Frame3D.backwardDirection)
    , Class.property "Rightward Direction" Frame3D.rightwardDirection $(docs 'Frame3D.rightwardDirection)
    , Class.property "Leftward Direction" Frame3D.leftwardDirection $(docs 'Frame3D.leftwardDirection)
    , Class.property "Upward Direction" Frame3D.upwardDirection $(docs 'Frame3D.upwardDirection)
    , Class.property "Downward Direction" Frame3D.downwardDirection $(docs 'Frame3D.downwardDirection)
    , Class.property "Forward Axis" Frame3D.forwardAxis $(docs 'Frame3D.forwardAxis)
    , Class.property "Backward Axis" Frame3D.backwardAxis $(docs 'Frame3D.backwardAxis)
    , Class.property "Rightward Axis" Frame3D.rightwardAxis $(docs 'Frame3D.rightwardAxis)
    , Class.property "Leftward Axis" Frame3D.leftwardAxis $(docs 'Frame3D.leftwardAxis)
    , Class.property "Upward Axis" Frame3D.upwardAxis $(docs 'Frame3D.upwardAxis)
    , Class.property "Downward Axis" Frame3D.downwardAxis $(docs 'Frame3D.downwardAxis)
...
step = do
  ...
  Class.new @Step "A STEP model that can be written out to a file." $
    ...
    , Class.constant "Derived Attribute" Step.derived $(docs 'Step.derived)
    , Class.constant "Null Attribute" Step.null $(docs 'Step.null)
    , Class.static1 "Bool Attribute" "Value" Step.bool $(docs 'Step.bool)
    , Class.static1 "Int Attribute" "Value" Step.int $(docs 'Step.int)
    , Class.static1 "Number Attribute" "Value" Step.number $(docs 'Step.number)
    , Class.static1 "Text Attribute" "Value" Step.text $(docs 'Step.text)
    , Class.static1 "Enum Attribute" "Value" Step.enum $(docs 'Step.enum)
    , Class.static1 "List Attribute" "Values" list $(docs 'Step.list)
    ]
